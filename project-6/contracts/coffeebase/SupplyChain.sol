...
contract SupplyChain {
  ...
  function buyItem(uint _upc) public payable forSale(_upc) paidEnough(items[_upc].productPrice) checkValue(_upc)
    ...
    items[_upc].originFarmerID.transfer(items[_upc].price);
  ...
  function shipItem(uint _upc) public purchased(_upc) verifyCaller(items[_upc].distributorID)
    // Call modifier to check if upc has passed previous supply chain stage
